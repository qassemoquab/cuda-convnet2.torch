...
//    conv_img_acts_manycolor_preloadfh_ty_4_tx_32_c_12_ff_16_fh_16< 4, 32, 4, 12, 16, 16, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(
                ...
                if (numFilterColors % 8 == 0) {
                    if (numFilterColors % 64 == 0) {
                      ...
                      checkCudaErrors(cudaDestroyTextureObject(texHidActs));
                            ...
                            conv_img_acts_manycolor_kepler < 8, 32, 2, 8, 32, 16, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                            ...
                            conv_img_acts_manycolor_kepler < 8, 32, 1, 8, 32, 16, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        ...
                        if (numImages % 128 == 0) {
                          ...
                          cudaTextureObject_t texHidActs = THCudaTensor_getTextureObject(hidActs);
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_preloadfh_ty_4_tx_32_c_12_ff_16_fh_16< 4, 32, 4, 12, 16, 16, false, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_preloadfh_ty_4_tx_32_c_12_ff_16_fh_16< 4, 32, 4, 12, 16, 16, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(texHidActs, texFilters, THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                      checkCudaErrors(cudaDestroyTextureObject(texFilters));
                      checkCudaErrors(cudaDestroyTextureObject(texHidActs));
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 2, 12, 16, 16, false, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 2, 12, 16, 16, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, false, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, false, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            conv_img_acts_manycolor_kepler < 4, 32, 4, 8, 32, 16, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 2, 8, 32, 16, false, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 2, 8, 32, 16, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, false, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, false, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            conv_img_acts_manycolor_kepler < 4, 32, 4, 4, 16, 16, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 2, 4, 16, 16, false, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 2, 4, 16, 16, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, false, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, false, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            conv_img_acts_manycolor_kepler < 4, 32, 4, 2, 16, 16, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 2, 2, 16, 16, false, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 2, 2, 16, 16, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, false, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, false, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                    ...
                    if (numFilterColors == 4) {
                        if (numImages % 128 == 0) {
                            ...
                            img_acts_mediumcolor < 8, 4, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(img_acts_mediumcolor < 4, 4, false, false, true >, cudaFuncCachePreferShared);
                            img_acts_mediumcolor < 4, 4, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(img_acts_mediumcolor < 2, 4, false, false, true >, cudaFuncCachePreferShared);
                            img_acts_mediumcolor < 2, 4, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(img_acts_mediumcolor < 2, 4, false, false, true >, cudaFuncCachePreferShared);
                            img_acts_mediumcolor < 2, 4, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            img_acts_color < 8, 2, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 4, 2, false, false, true >, cudaFuncCachePreferShared);
                            img_acts_color < 4, 2, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 2, false, false, true >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 2, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 2, false, false, true >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 2, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                    ...
                    if (numFilterColors == 3) {
                        if (numImages % 128 == 0) {
                            ...
                            img_acts_color < 8, 3, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 4, 3, false, false, true >, cudaFuncCachePreferShared);
                            img_acts_color < 4, 3, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 3, false, false, true >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 3, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 3, false, false, true >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 3, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            img_acts_color < 8, 1, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 4, 1, false, false, true >, cudaFuncCachePreferShared);
                            img_acts_color < 4, 1, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 1, false, false, true >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 1, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 1, false, false, true >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 1, false, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                ...
                if (numFilterColors % 8 == 0) {
                    if (numFilterColors % 64 == 0) {
                        if (numImages % 1 == 0) {
                            ...
                            conv_img_acts_manycolor_kepler < 8, 32, 1, 8, 32, 16, false, true, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors % 48 == 0) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, false, true, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, false, true, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors % 32 == 0) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, false, true, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, false, true, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors % 16 == 0) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, false, true, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, false, true, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors % 8 == 0) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, false, true, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, false, true, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                }
                else if (numFilterColors > 3) {
                    if (numFilterColors == 4) {
                        if (numImages % 1 == 0) {
                            ...
                            img_acts_mediumcolor < 2, 4, false, true, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors == 2) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 2, false, true, true >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 2, false, true, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                    }
                }
                else if (numFilterColors <= 3) {
                    if (numFilterColors == 3) {
                        if (numImages % 1 == 0) {
                            ...
                            img_acts_color < 2, 3, false, true, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors == 2) {
                        if (numImages % 1 == 0) {
                        ...
                        if (numImages % 1 == 0) {
                            ...
                            img_acts_color < 2, 1, false, true, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                    }
                }
            }
                ...
                if (numFilterColors % 8 == 0) {
                    if (numFilterColors % 64 == 0) {
                        if (numImages % 128 == 0) {
                          ...
                          cudaTextureObject_t texHidActs = THCudaTensor_getTextureObject(hidActs);
                            ...
                            conv_img_acts_manycolor_preloadfh_ty_8_tx_32_c_8_ff_32_fh_16_tex< 8, 32, 4, 8, 32, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(texHidActs, texFilters, THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                      checkCudaErrors(cudaDestroyTextureObject(texFilters));
                      checkCudaErrors(cudaDestroyTextureObject(texHidActs));
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 8, 32, 2, 8, 32, 16, true, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 8, 32, 2, 8, 32, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 8, 32, 1, 8, 32, 16, true, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 8, 32, 1, 8, 32, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 8, 32, 1, 8, 32, 16, true, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 8, 32, 1, 8, 32, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                          ...
                          cudaTextureObject_t texHidActs = THCudaTensor_getTextureObject(hidActs);
                            ...
                            conv_img_acts_manycolor_preloadfh_ty_4_tx_32_c_12_ff_16_fh_16< 4, 32, 4, 12, 16, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(texHidActs, texFilters, THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                      checkCudaErrors(cudaDestroyTextureObject(texFilters));
                      checkCudaErrors(cudaDestroyTextureObject(texHidActs));
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 2, 12, 16, 16, true, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 2, 12, 16, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, true, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, true, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            conv_img_acts_manycolor_kepler < 4, 32, 4, 8, 32, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 2, 8, 32, 16, true, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 2, 8, 32, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, true, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, true, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            conv_img_acts_manycolor_kepler < 4, 32, 4, 4, 16, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 2, 4, 16, 16, true, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 2, 4, 16, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, true, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, true, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            conv_img_acts_manycolor_kepler < 4, 32, 4, 2, 16, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 2, 2, 16, 16, true, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 2, 2, 16, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, true, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, true, false, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                    ...
                    if (numFilterColors == 4) {
                        if (numImages % 128 == 0) {
                            ...
                            img_acts_mediumcolor < 8, 4, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(img_acts_mediumcolor < 4, 4, true, false, true >, cudaFuncCachePreferShared);
                            img_acts_mediumcolor < 4, 4, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(img_acts_mediumcolor < 2, 4, true, false, true >, cudaFuncCachePreferShared);
                            img_acts_mediumcolor < 2, 4, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(img_acts_mediumcolor < 2, 4, true, false, true >, cudaFuncCachePreferShared);
                            img_acts_mediumcolor < 2, 4, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            img_acts_color < 8, 2, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 4, 2, true, false, true >, cudaFuncCachePreferShared);
                            img_acts_color < 4, 2, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 2, true, false, true >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 2, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 2, true, false, true >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 2, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                    ...
                    if (numFilterColors == 3) {
                        if (numImages % 128 == 0) {
                            ...
                            img_acts_color < 8, 3, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 4, 3, true, false, true >, cudaFuncCachePreferShared);
                            img_acts_color < 4, 3, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 3, true, false, true >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 3, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 3, true, false, true >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 3, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            img_acts_color < 8, 1, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 4, 1, true, false, true >, cudaFuncCachePreferShared);
                            img_acts_color < 4, 1, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 1, true, false, true >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 1, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 1, true, false, true >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 1, true, false, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                ...
                if (numFilterColors % 8 == 0) {
                    if (numFilterColors % 64 == 0) {
                        if (numImages % 1 == 0) {
                            ...
                            conv_img_acts_manycolor_kepler < 8, 32, 1, 8, 32, 16, true, true, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors % 48 == 0) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, true, true, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, true, true, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors % 32 == 0) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, true, true, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, true, true, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors % 16 == 0) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, true, true, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, true, true, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors % 8 == 0) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, true, true, true >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, true, true, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                }
                else if (numFilterColors > 3) {
                    if (numFilterColors == 4) {
                        if (numImages % 1 == 0) {
                            ...
                            img_acts_mediumcolor < 2, 4, true, true, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors == 2) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 2, true, true, true >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 2, true, true, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                    }
                }
                else if (numFilterColors <= 3) {
                    if (numFilterColors == 3) {
                        if (numImages % 1 == 0) {
                            ...
                            img_acts_color < 2, 3, true, true, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors == 2) {
                        if (numImages % 1 == 0) {
                        ...
                        if (numImages % 1 == 0) {
                            ...
                            img_acts_color < 2, 1, true, true, true ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                    }
                }
            }
                ...
                if (numFilterColors % 8 == 0) {
                    if (numFilterColors % 64 == 0) {
                        if (numImages % 128 == 0) {
                          ...
                          cudaTextureObject_t texHidActs = THCudaTensor_getTextureObject(hidActs);
                            ...
                            conv_img_acts_manycolor_preloadfh_ty_8_tx_32_c_8_ff_32_fh_16_tex< 8, 32, 4, 8, 32, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(texHidActs, texFilters, THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                      checkCudaErrors(cudaDestroyTextureObject(texFilters));
                      checkCudaErrors(cudaDestroyTextureObject(texHidActs));
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 8, 32, 2, 8, 32, 16, false, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 8, 32, 2, 8, 32, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 8, 32, 1, 8, 32, 16, false, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 8, 32, 1, 8, 32, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 8, 32, 1, 8, 32, 16, false, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 8, 32, 1, 8, 32, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                          ...
                          cudaTextureObject_t texHidActs = THCudaTensor_getTextureObject(hidActs);
                            ...
                            conv_img_acts_manycolor_preloadfh_ty_4_tx_32_c_12_ff_16_fh_16< 4, 32, 4, 12, 16, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(texHidActs, texFilters, THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                      checkCudaErrors(cudaDestroyTextureObject(texFilters));
                      checkCudaErrors(cudaDestroyTextureObject(texHidActs));
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 2, 12, 16, 16, false, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 2, 12, 16, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, false, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, false, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            conv_img_acts_manycolor_kepler < 4, 32, 4, 8, 32, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 2, 8, 32, 16, false, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 2, 8, 32, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, false, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, false, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            conv_img_acts_manycolor_kepler < 4, 32, 4, 4, 16, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 2, 4, 16, 16, false, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 2, 4, 16, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, false, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, false, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            conv_img_acts_manycolor_kepler < 4, 32, 4, 2, 16, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 2, 2, 16, 16, false, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 2, 2, 16, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, false, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, false, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                    ...
                    if (numFilterColors == 4) {
                        if (numImages % 128 == 0) {
                            ...
                            img_acts_mediumcolor < 8, 4, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(img_acts_mediumcolor < 4, 4, false, false, false >, cudaFuncCachePreferShared);
                            img_acts_mediumcolor < 4, 4, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(img_acts_mediumcolor < 2, 4, false, false, false >, cudaFuncCachePreferShared);
                            img_acts_mediumcolor < 2, 4, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(img_acts_mediumcolor < 2, 4, false, false, false >, cudaFuncCachePreferShared);
                            img_acts_mediumcolor < 2, 4, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            img_acts_color < 8, 2, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 4, 2, false, false, false >, cudaFuncCachePreferShared);
                            img_acts_color < 4, 2, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 2, false, false, false >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 2, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 2, false, false, false >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 2, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                    ...
                    if (numFilterColors == 3) {
                        if (numImages % 128 == 0) {
                            ...
                            img_acts_color < 8, 3, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 4, 3, false, false, false >, cudaFuncCachePreferShared);
                            img_acts_color < 4, 3, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 3, false, false, false >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 3, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 3, false, false, false >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 3, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            img_acts_color < 8, 1, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 4, 1, false, false, false >, cudaFuncCachePreferShared);
                            img_acts_color < 4, 1, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 1, false, false, false >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 1, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 1, false, false, false >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 1, false, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                ...
                if (numFilterColors % 8 == 0) {
                    if (numFilterColors % 64 == 0) {
                        if (numImages % 1 == 0) {
                            ...
                            conv_img_acts_manycolor_kepler < 8, 32, 1, 8, 32, 16, false, true, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors % 48 == 0) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, false, true, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, false, true, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors % 32 == 0) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, false, true, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, false, true, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors % 16 == 0) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, false, true, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, false, true, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors % 8 == 0) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, false, true, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, false, true, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                }
                else if (numFilterColors > 3) {
                    if (numFilterColors == 4) {
                        if (numImages % 1 == 0) {
                            ...
                            img_acts_mediumcolor < 2, 4, false, true, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors == 2) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 2, false, true, false >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 2, false, true, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                    }
                }
                else if (numFilterColors <= 3) {
                    if (numFilterColors == 3) {
                        if (numImages % 1 == 0) {
                            ...
                            img_acts_color < 2, 3, false, true, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors == 2) {
                        if (numImages % 1 == 0) {
                        ...
                        if (numImages % 1 == 0) {
                            ...
                            img_acts_color < 2, 1, false, true, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                    }
                }
            }
                ...
                if (numFilterColors % 8 == 0) {
                    if (numFilterColors % 64 == 0) {
                        if (numImages % 128 == 0) {
                          ...
                          cudaTextureObject_t texHidActs = THCudaTensor_getTextureObject(hidActs);
                            ...
                            conv_img_acts_manycolor_preloadfh_ty_8_tx_32_c_8_ff_32_fh_16_tex< 8, 32, 4, 8, 32, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(texHidActs, texFilters, THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                      checkCudaErrors(cudaDestroyTextureObject(texFilters));
                      checkCudaErrors(cudaDestroyTextureObject(texHidActs));
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 8, 32, 2, 8, 32, 16, true, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 8, 32, 2, 8, 32, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 8, 32, 1, 8, 32, 16, true, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 8, 32, 1, 8, 32, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 8, 32, 1, 8, 32, 16, true, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 8, 32, 1, 8, 32, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                          ...
                          cudaTextureObject_t texHidActs = THCudaTensor_getTextureObject(hidActs);
                            ...
                            conv_img_acts_manycolor_preloadfh_ty_4_tx_32_c_12_ff_16_fh_16< 4, 32, 4, 12, 16, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(texHidActs, texFilters, THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                      checkCudaErrors(cudaDestroyTextureObject(texFilters));
                      checkCudaErrors(cudaDestroyTextureObject(texHidActs));
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 2, 12, 16, 16, true, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 2, 12, 16, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, true, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, true, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            conv_img_acts_manycolor_kepler < 4, 32, 4, 8, 32, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 2, 8, 32, 16, true, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 2, 8, 32, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, true, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, true, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            conv_img_acts_manycolor_kepler < 4, 32, 4, 4, 16, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 2, 4, 16, 16, true, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 2, 4, 16, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, true, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, true, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            conv_img_acts_manycolor_kepler < 4, 32, 4, 2, 16, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 2, 2, 16, 16, true, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 2, 2, 16, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, true, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, true, false, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                    ...
                    if (numFilterColors == 4) {
                        if (numImages % 128 == 0) {
                            ...
                            img_acts_mediumcolor < 8, 4, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(img_acts_mediumcolor < 4, 4, true, false, false >, cudaFuncCachePreferShared);
                            img_acts_mediumcolor < 4, 4, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(img_acts_mediumcolor < 2, 4, true, false, false >, cudaFuncCachePreferShared);
                            img_acts_mediumcolor < 2, 4, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(img_acts_mediumcolor < 2, 4, true, false, false >, cudaFuncCachePreferShared);
                            img_acts_mediumcolor < 2, 4, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            img_acts_color < 8, 2, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 4, 2, true, false, false >, cudaFuncCachePreferShared);
                            img_acts_color < 4, 2, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 2, true, false, false >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 2, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 2, true, false, false >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 2, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                    ...
                    if (numFilterColors == 3) {
                        if (numImages % 128 == 0) {
                            ...
                            img_acts_color < 8, 3, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 4, 3, true, false, false >, cudaFuncCachePreferShared);
                            img_acts_color < 4, 3, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 3, true, false, false >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 3, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 3, true, false, false >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 3, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        ...
                        if (numImages % 128 == 0) {
                            ...
                            img_acts_color < 8, 1, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 64 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 4, 1, true, false, false >, cudaFuncCachePreferShared);
                            img_acts_color < 4, 1, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 32 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 1, true, false, false >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 1, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                        else if (numImages % 16 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 1, true, false, false >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 1, true, false, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                ...
                if (numFilterColors % 8 == 0) {
                    if (numFilterColors % 64 == 0) {
                        if (numImages % 1 == 0) {
                            ...
                            conv_img_acts_manycolor_kepler < 8, 32, 1, 8, 32, 16, true, true, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors % 48 == 0) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, true, true, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 12, 16, 16, true, true, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors % 32 == 0) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, true, true, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 8, 32, 16, true, true, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors % 16 == 0) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, true, true, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 4, 16, 16, true, true, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors % 8 == 0) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, true, true, false >, cudaFuncCachePreferShared);
                            conv_img_acts_manycolor_kepler < 4, 32, 1, 2, 16, 16, true, true, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                }
                else if (numFilterColors > 3) {
                    if (numFilterColors == 4) {
                        if (numImages % 1 == 0) {
                            ...
                            img_acts_mediumcolor < 2, 4, true, true, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, numImgColors, numGroups, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors == 2) {
                        if (numImages % 1 == 0) {
                            cudaFuncSetCacheConfig(img_acts_color < 2, 2, true, true, false >, cudaFuncCachePreferShared);
                            img_acts_color < 2, 2, true, true, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                    }
                }
                else if (numFilterColors <= 3) {
                    if (numFilterColors == 3) {
                        if (numImages % 1 == 0) {
                            ...
                            img_acts_color < 2, 3, true, true, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                    }
                    else if (numFilterColors == 2) {
                        if (numImages % 1 == 0) {
                        ...
                        if (numImages % 1 == 0) {
                            ...
                            img_acts_color < 2, 1, true, true, false ><<<blocks, threads, 0, cutorchCurrentStream>>>(THCudaTensor_data(hidActs), THCudaTensor_data(filters), THCudaTensor_data(targets), numModulesY, numModulesX, numImages, numFilters, filterSize, imgSizeY, imgSizeX, paddingStart, moduleStride, scaleTargets, scaleOutput);
                        }
                    }
                }
            }
